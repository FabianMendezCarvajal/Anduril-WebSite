...
|---|---|---|---|---|
| 1 | Blank, full width, tall | Ivory | **Code Block** hero, centred, and **Code Block** celestial chart anywhere in the section (its disc rises from the bottom edge as the background; its controls fold into a dial at the right) | `code-blocks/hero-headline.html` + `code-blocks/celestial-chart.html` |
