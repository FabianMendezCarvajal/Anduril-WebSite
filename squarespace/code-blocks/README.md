...
| `celestial-chart.html` | Home, section 1, under the hero block: the working sky wheel rising from the bottom edge, its controls behind a dial at the right (needs JavaScript, Core plan or higher) | Ivory |
