...
| `celestial-chart.html` | Home, section 1, under the hero block: the working sky wheel rising from the bottom edge, with the turn controls (needs JavaScript, Core plan or higher) | Ivory |
